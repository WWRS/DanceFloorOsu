...
public static class FloorUtils
{
    ...
    public static void PlayPattern(DanceFloor floor, Func<int, int[]> pattern, int[] ts, float time, float offset = 0, Action<int[]> call = null)
    {
    ...
    public static void PlayPattern(DanceFloor floor, Func<int, int[]> pattern, int tCount, float time, float offset = 0, Action<int[]> call = null)
    {
